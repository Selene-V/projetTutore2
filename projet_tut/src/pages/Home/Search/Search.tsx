...
const Search = (props: {
    ...
    return (
        <div className={changeZIndex + " fixed w-5/12 relative inline-block min-w-min h-full text-black"}>
            ...
            <div
                className={classCss + " pb-2 w-72 lg:w-full text-sm lg:Forigin-top-right absolute  mt-1 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none bg-white"}
