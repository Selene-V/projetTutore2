    ...
    return (
        <div className="kk">
                <div className="flex flex-row-reverse rounded-xl">
                    <div className=" flex border-4 border-gray-400 rounded-2xl">
                        <div className={classCss[0]+" border-4 border-gray-400 hover:bg-yellow-600  p-1"}>
                            <label className="inline-flex items-center px-2">
                                <input name="test" type="radio"
                                       ...
                                       />
                                <i className="fa fa-bars fa-1x" aria-hidden="true" onClick={() => changeBoolean(true)}/>
                        ...
                        <div className={classCss[1]+" border-4 border-gray-400 hover:bg-yellow-600 p-1"}>
                            <label className="inline-flex items-center px-2">
                                <input name="test" type="radio"
                                       ...
                                       />
                                <i className="fa fa-th fa-1x" aria-hidden="true" onClick={() => changeBoolean(false)}/>
                            </label>
                        </div>
                    </div>
            </div>
